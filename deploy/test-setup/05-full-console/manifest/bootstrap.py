#!/usr/bin/env python3
"""
Bootstrap rich test data into a running DashCenter 05-full-console stack.
...
Usage:
    python3 bootstrap.py                          # default: http://localhost:28443
    python3 bootstrap.py http://10.0.0.5:28443    # custom endpoint
"""
import json
import sys
import time
...
DASHD = sys.argv[1] if len(sys.argv) > 1 else "http://localhost:28443"
...
print(f"             19 route policies, 20 ACL policies,")
...
print(f"{'═'*60}")
print(f"\n  Open http://localhost:3000 to explore the console.")

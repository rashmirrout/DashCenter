...
![DPU Fleet Networking Platform — Vision](docs/dpu-fleet-networking-platform-hq.png)

> *Figure 4-0 — The vision: a single, open, cloud-native control plane that unifies any mix of DASH-compliant DPUs under one declaratively-managed, multi-tenant networking computer.*
